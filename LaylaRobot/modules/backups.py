...
def export_data(update, context):
    ...
    with open("Hatsune_Miku{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        ...
        caption="💾*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `Hatsune_Miku-Backup` was specially made for notes 📚.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("Hatsune_Miku{}.backup".format(chat_id))  # Cleaning file
